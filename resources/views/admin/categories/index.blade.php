...
@section('content')
    ...
    <div class="mb-8 flex justify-between items-end">
        ...
        <a href="{{ route('admin.categories.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-lg text-sm font-medium transition-colors shadow-sm">
            + Add New Category
        </a>
    </div>
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="py-4 px-6 w-32">
                                <div class="flex items-center justify-end gap-4">
                                    <a href="{{ route('admin.categories.edit', $category->id) }}" class="text-gray-400 hover:text-blue-600 transition" title="Edit">
